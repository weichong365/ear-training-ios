...
- 14 个有源 PDF 资料的省份真题框架建卷、浙江选择卷、断点恢复、交卷评分和逐题复盘。
- Apple StoreKit 订阅、7 天免费试用、恢复购买和订阅管理（由 RevenueCat 处理匿名权益状态）。
- EAS Production 构建与 App Store Connect 自动提交；当前 TestFlight 构建为 1.0.0 (16)。

## 上线前仍需完成

- 补齐运营主体、技术支持邮箱，并部署公开隐私政策和技术支持网址。
- 最终确认 App 图标，制作 App Store 截图并完成隐私标签。
- 在 TestFlight 真机完成音频中断、订阅购买/恢复和 14 省试卷验收。
