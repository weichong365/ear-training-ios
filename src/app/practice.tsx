    ...
    <ScrollView
      ...
      {phase === 'finished' ? <View style={styles.resultCard}>
        ...
        <View style={[styles.keyboardCard, phase === 'feedback' && styles.keyboardOpen]}>
          ...
          <View style={styles.keyboardStage}><View aria-hidden={phase !== 'feedback'} accessibilityElementsHidden={phase !== 'feedback'} importantForAccessibility={phase !== 'feedback' ? 'no-hide-descendants' : 'auto'}><PianoKeyboard startMidi={55} endMidi={81} disabled={phase !== 'feedback' || playing || preparing} highlights={highlights} volume={volume} onKeyPress={phase === 'feedback' ? reviewPianoKey : undefined} /></View>{phase !== 'feedback' && <View accessibilityRole="text" accessibilityLabel="复盘钢琴待解锁，提交答案后解锁" style={styles.keyboardLock}><View style={styles.lockIcon}><View style={styles.lockShackle} /><View style={styles.lockBody}><View style={styles.lockHole} /></View></View></View>}</View>
        </View>
      </>}
    </ScrollView>
