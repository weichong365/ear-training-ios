...
const styles = StyleSheet.create({
  ...
  menu: { position: 'absolute', zIndex: 5, top: -59, right: 8, flexDirection: 'row', alignItems: 'center', gap: 5, padding: 6, borderRadius: Radius.control, backgroundColor: Brand.ivory, borderWidth: 1, borderColor: Brand.border, shadowColor: Brand.shadow, shadowOpacity: 0.12, shadowRadius: 7, shadowOffset: { width: 0, height: 3 }, elevation: 5 },
