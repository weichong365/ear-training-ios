...
const styles = StyleSheet.create({
  ...
  systemCardInk: { borderColor: '#141414', backgroundColor: '#FFFFFF' }, systemLabelInk: { color: '#141414' }, systemBeatInk: { color: '#141414' },
  timedClef: { position: 'absolute', left: 4, top: 11, width: 38, height: 96 },
});
